(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["polyfills-es5"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\new projects 11-2022\jan-2023-kioskapp\new-16-05-2023\new-16-05-2023\src\polyfills.ts */
      "hN/g");
      /***/
    },
      ...
      function patchEventTarget(_global, api, apis, patchOptions) {
        ...
        function globalCallback(context, event, isCapture) {
          ...
          if (tasks) {
            ...
            if (tasks.length === 1) {
              var _err = invokeTask(tasks[0], target, event);
              ...
              for (var i = 0; i < copyTasks.length; i++) {
                ...
                var _err2 = invokeTask(copyTasks[i], target, event);
